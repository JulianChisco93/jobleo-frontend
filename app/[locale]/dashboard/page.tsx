...
import { getSearchProfiles, getJobAlerts, getMe, getSearchProfileLogs } from "@/lib/api";
...
export default function DashboardPage() {
  ...
  const showOnboardingBlock = !profilesLoading && profiles.length === 0;

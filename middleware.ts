...
export async function middleware(request: NextRequest) {
  ...
  if (!isDashboardPath(pathname) && !isOnboardingPath(pathname) && !isLoginPath(pathname) && !isAdminPath(pathname)) {
    return intlResponse;
  }
  ...
  if (!user && (isDashboardPath(pathname) || isOnboardingPath(pathname) || isAdminPath(pathname))) {
